...
Chess library with implementations for board management, game state, move operations, and piece handling.
...
- **[move.c](move.c.md)**: Implements chess move operations, including creation, comparison, and UCI string conversion.
...
- **[squareset.c](squareset.c.md)**: Square set implementation for managing and accessing bitwise square data in a chess library.
